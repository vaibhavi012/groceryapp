...
<body>
    <div class="container">
        ...
        <div class="item">
            ...
            <form method="POST" action="customerchangepwd.php" name="regform" onsubmit="return validate();">
                <table class="table" style="font-weight:bold; width:100%;" >
                    ...
                    <tr>
                        <td colspan="2"><input type="submit" class="btn btn-success" name="btn" value="change"></td>
                </table>
            </form>
        </div>
    </div>
