...
$stmt=$conn->prepare("select orders.custcode,firmname,ordernum,orderdate,amt,shipping,netamount,deliveryneeded,labourneeded,labour,status from orders inner join customer on customer.custcode=orders.custcode where status='Delivered'");
$stmt->execute();
$c=$stmt->rowCount();
...
<html>
<head>
    <title>View Delivered Orders</title>
    <?php
...
<body>
    ...
    <div class="item">
    <h1>View Delivered Orders</h1></br>
